...
module.exports = function (EOTranslator) {
  test("Adding a basic translation at run time.", () => {
    // Arrange
    let translator;
    const dict = {};
  ...
  test("Editing a basic translation at run time.", () => {
    // Arrange
    let translator;
    const dict = {
      en: {
  ...
  test("Removing a translation at run time.", () => {
    // Arrange
    let translator;
    const dict = {
      en: {
  ...
  test("Adding a nested translation at run time.", () => {
    // Arrange
    let translator;
    const dict = {
      en: {
  ...
  test("Adding a nested translation to an nestable object at run time.", () => {
    // Arrange
    let translator;
    const dict = {
      en: {
  ...
  test("Updating nested translations at run time.", () => {
    // Arrange
    let translator;
    const dict = {
      en: {
  ...
  test("Removing a nested translation at run time.", () => {
    // Arrange
    let translator;
    const dict = {
      en: {
